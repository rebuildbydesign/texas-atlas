...
function addLayers() {
    map.addSource('texasfema', {
        type: 'geojson',
        data: 'data/TX_FEMA_County.geojson'
    });
...
function addCongressionalLayers() {
    map.addSource('txCongress', {
        type: 'geojson',
        data: 'data/TX_Congress.geojson'
    });
...
function addHouseLayers() {
    map.addSource('txHouse', {
        type: 'geojson',
        data: 'data/TX_House.geojson'
    });
...
function addSenateLayers() {
    map.addSource('txSenate', {
        type: 'geojson',
        data: 'data/TX_Senate.geojson'
    });
